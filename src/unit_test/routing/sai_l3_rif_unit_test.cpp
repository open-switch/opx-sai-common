...
/**
 * @file  sai_l3_rif_unit_test.cpp
 *
 * @brief This file contains the google unit test cases to test the
 *        SAI APIS for Router Interface functionality.
 */
...
TEST_F (saiL3RifTest, rif_create_with_mac_attr_on_vrf_with_mac_attr)
{
    ...
    bool             vrf_v6_state = false;
    uint8_t          sai_mac [6];
    const char       *mac_str = "00:a0:a1:a2:a3:a6";
...
TEST_F (saiL3RifTest, create_rif_with_all_attr_on_vrf_with_all_attr)
{
    ...
    const char                *mac_str = "00:a0:a1:a2:a3:07";
...
TEST_F (saiL3RifTest, port_rif_optional_attr_set)
{
    ...
    const char   *mac [3] = {"00:a0:a1:a2:a3:04", "00:a0:a1:a2:a3:05",
                             router_mac};
